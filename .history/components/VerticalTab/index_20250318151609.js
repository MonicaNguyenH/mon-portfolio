...
export default function VerticalTab() {
  ...
  useEffect(() => {
    if (activeTab === "print") {
      gsap.to(printContentRef.current, { width: "92%", opacity: 1, duration: 0.3, ease: "elastic.out(1, 0.5)" });
      gsap.to(digitalContentRef.current, { width: "0%", opacity: 0, duration: 0.3, ease: "power2.inOut" });
    } else {
      gsap.to(digitalContentRef.current, { width: "92%", opacity: 1, duration: 0.3, ease: "elastic.out(1, 0.5)" });
      gsap.to(printContentRef.current, { width: "0%", opacity: 0, duration: 0.3, ease: "power2.inOut" });
    }
  }, [activeTab]);
