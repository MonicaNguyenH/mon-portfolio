...
export default function VerticalTab() {
  ...
  useEffect(() => {
    if (activeTab === "print") {
      gsap.to(printContentRef.current, { width: "92%", opacity: 1, duration: 0.2, ease: "power2.inOut" });
      gsap.to(digitalContentRef.current, { width: "0%", opacity: 0, duration: 0.2, ease: "power2.inOut" });
    } else {
      gsap.to(digitalContentRef.current, { width: "92%", opacity: 1, duration: 0.2, ease: "power2.inOut" });
      gsap.to(printContentRef.current, { width: "0%", opacity: 0, duration: 0.2, ease: "power2.inOut" });
    }
  }, [activeTab]);
