import styles from './StringTest.module.csss';
import gsap from 'gsap';
import { useEffect, useRef } from 'react';

export default function StringTest({ onMouseMove }) {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (event) => {
            ...
            const t = offsetX / container.offsetWidth;
            ...
            // Pass mouse move data to parent if needed
