...
import styles from "../styles/ComparisonSlider.module.css"; // Import module CSS
    ...
    import("gsap").then((gsapModule) => {
      ...
      import("gsap/ScrollTrigger").then((scrollTriggerModule) => {
        ...
        if (sectionRef.current) {
          ...
          // Ensure the animation starts properly regardless of scroll direction
          ...
          // Force a refresh after animations are set
          ScrollTrigger.refresh();
        }
      });
    });
