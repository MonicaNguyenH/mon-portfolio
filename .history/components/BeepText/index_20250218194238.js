  ...
  return (
    <>
        ...
        <div className={styles.text} ref={textRef}>
            {/* <span  className={styles.beep__main}>BEEEEEEEEEEEEEEEEEEEEEEEEEEE</span>
            <span className={styles.beep__ep}>EP</span> */}
            <p>Macaroon croissant pastry shortbread</p> 
            <p>cupcake chupa chups pudding.</p>
        </div>
    </>
