...
export default function HiddenContent() {
  ...
  return (
    <div className={`${styles.bg} position-relative pb-5`}>
      <div className={styles.content}>
        <div className="container">
          ...
          <div className="row justify-content-center align-items-center min-vh-100">
            <div className="col-12 col-md-10 col-lg-8">
              <p className="display-3 fw-bold text-center">Do not share this information with anyone</p>
            </div>
          </div>
          <div className="text-center">
            <a className={styles.link} href="https://greensock.com/" target="_blank" rel="noopener noreferrer">
              <span>psst discover more</span>
              <i className={`${styles.btnIcon} bi bi-arrow-right-short fs-4`}></i>
            </a>
          </div>
        </div>
      </div>
      <div className={styles.hiddenContent}>
        <div className="container">
          <div className="row justify-content-center align-items-center min-vh-100">
            <div className="col-12 col-md-10 col-lg-8">
              <p className="display-3 fw-bold text-center">I am convinced that cats secretly control the Internet.</p>
            </div>
          </div>
          <div className="row justify-content-center align-items-center min-vh-100">
            <div className="col-12 col-md-10 col-lg-8">
              <p className="display-3 fw-bold text-center">especially not with the cats!</p>
            </div>
          </div>
        </div>
      </div>
