...
const projectData = [
    {
        ...
        year: 2024,
        image: "/images/beep.jpg", // Replace with actual image paths
    },
    {
        id: "p2",
        name: "Trea",
...
export default function MenuOverlay() {
    ...
    return (
        <div className={styles.main}>
            {/* Preview Box */}
            <div ref={previewRef} className={styles.preview} style={{ position: "absolute", scale: 0 }}>
                {activeImage && <img ref={previewImgRef} src={activeImage} alt="Preview" className={styles.previewImg} />}
            </div>
