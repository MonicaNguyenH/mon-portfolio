                                ...
                                <div
                                    ...
                                    onMouseEnter={() => {
                                        if (activeImage !== project.image) {
                                            ...
                                            const direction = prevIndex < newIndex ? 1 : -1; // 1 = Down, -1 = Up
                                    
                                            // Animate only the image inside previewRef
                                            gsap.fromTo(
                                                previewRef.current.querySelector("img"),
                                                { y: direction * 50, opacity: 0 }, // Start 50px up/down and invisible
                                                { y: 0, opacity: 1, duration: 0.4, ease: "power2.out" } // Slide into position
                                            );
