            ...
            import("gsap/ScrollTrigger").then(({ ScrollTrigger }) => {
                ...
                if (sectionRef.current) {
                    ...
                    let tl = gsap.timeline({
                        scrollTrigger: {
                            trigger: section,
                            start: "center center", // ✅ Fix: Starts when section reaches the middle of viewport
                            end: "+=" + section.offsetWidth, // ✅ Keeps smooth horizontal scrolling
                            scrub: true,
                            pin: true,
                            anticipatePin: 1,
                            pinSpacing: true, // ✅ Prevents layout shifts after animation
                            immediateRender: false, // ✅ Prevents animation glitches
                            invalidateOnRefresh: true, // ✅ Ensures proper recalculations
                        },
                        defaults: { ease: "none" },
                    });
