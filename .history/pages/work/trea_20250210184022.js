    ...
    return (
        <>
            ...
            <div className={styles.main}>
                ...
                <img  src="/img/graphic/trea/Peach1.webp" alt="Peach" className={styles.img} />
                <img src="/img/graphic/trea/Peach.webp" alt="Peach" className={styles.img} />

                <img src="/img/graphic/trea/Strawberry1.webp" alt="Strawberry" className={styles.img} />
                <img src="/img/graphic/trea/Strawberry.webp" alt="Strawberry" className={styles.img} />

                <img src="/img/graphic/trea/Mango1.webp" alt="Mango" className={styles.img} />
                <img src="/img/graphic/trea/Mango.webp" alt="Mango" className={styles.img} />

                <img src="/img/graphic/trea/allcans.webp" alt="Cans mockup" className={styles.img} />
