...
export default function Beep() {
    ...
    const horizontalRef = useRef(null);
        ...
        useEffect(() => {
            ...
            // Ensure all text inside ref is animated
            gsap.fromTo(
              textRef.current.children, // Target all <p> inside textRef
              { opacity: 0, y: 50 }, // Start invisible & shifted down
              {
                opacity: 1,
                y: 0,
                duration: 1.5,
                ease: "power3.out",
                stagger: 0.2, // Delay between lines appearing
                scrollTrigger: {
