                    ...
                    <div className={styles.fullscreen} ref={mainSectionRef}>
                        <div className={styles.container}>
                            <h1 ref={scrollTextRef} className={styles.scrollableText}>
                                <span className={styles.pinkText}>Art h</span> is the only way to run away without leaving home
                                <span className={styles.img}>
                                    <img src="/img/graphic/artflow/cover.webp" alt="Graphic Artflow Cover" />
                                </span>
                            </h1>
                        </div>
                    </div>
