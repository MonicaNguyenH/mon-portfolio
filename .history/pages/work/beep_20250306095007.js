...
export default function Beep() {
    ...
    useEffect(() => {
        if (!isReady) return; // ✅ Ensure GSAP runs only when images are loaded
    
        let ctx; // ✅ Store GSAP context to prevent conflicts
            ...
            import("gsap/ScrollTrigger").then(({ ScrollTrigger }) => {
                ...
                ctx = gsap.context(() => {
                    const scrollTrigger = ScrollTrigger.create({
                        trigger: horizontal,
                        start: "top bottom", // ✅ Wait until the section enters view
                    ...
                    // ✅ Refresh only this ScrollTrigger without affecting others
                    scrollTrigger.refresh();
                }, horizontalRef); // ✅ Scope animations to horizontalRef
            });
        });
