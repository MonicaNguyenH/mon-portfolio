...
export default function Beep() {
    ...
    const horizontalRef = useRef(null);
        ...
        useEffect(() => {
            ...
            gsap.fromTo(
                textRef.current,
                { opacity: 0, y: 50 }, // Start fully hidden and lower
                {
                    opacity: 1,
                    y: 0,
                    duration: 1.5,
                    ...
                    scrollTrigger: {
                        ...
                        start: "top 80%", // Adjust to make sure animation starts at right time
                        end: "top 50%",
                        toggleActions: "play none none none", // Ensures it runs only when entering
                    },
                }
            );
        }, []);
