                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.menu}>
                        <div className={styles.img}>
                            <img  src="/img/graphic/menu/menu-1.png" alt="Forelsket Menu 1" />
                        </div>

                        <div className={styles.img}>
                            <img  src="/img/graphic/menu/menu-2.png" alt="Forelsket Menu 2" />
                        </div>

                        <div className={styles.img}>
                            <img  src="/img/graphic/menu/menu-3.png" alt="Forelsket Menu 3" />
                        </div>
                    </div>
                </div>
