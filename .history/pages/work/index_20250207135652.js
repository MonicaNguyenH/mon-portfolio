...
export default function Work() {
    ...
    const content = {
        ...
        "GRAPHIC DESIGN": (
            <div className={styles.gridContainer}>
                    <Card link="/work/trea" image="/img/graphic/trea/TN.png" title="TREA" year="2024" gridSize="wide" />
                    ...
                    <Card link="/work/millenova" image="/img/graphic/millenova/TN.png" title="MILLENOVA" year="2024" gridSize="small" />
                    <Card link="/work/forelsket" image="/img/graphic/lalaland/TN.png" title="LALALAND" year="2024" gridSize="small" />
                    <Card link="/work/forelsket" image="/img/graphic/object/cover.png" title="ELECTRICAL DEVICE" year="2023" gridSize="wide" />

                    <Card link="/work/forelsket" image="/img/graphic/book/TN.png" title="THE STARFRUIT TREE" year="2024" gridSize="wide" />
            </div>
        ),
        "UX/UI DESIGN": (
            <></>
