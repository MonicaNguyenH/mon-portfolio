                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.embedded}>
                        <div className={styles.print}>
                            <iframe className={styles.indesign} src="https://indd.adobe.com/embed/cab41585-505e-4441-9fb6-541fd30ed968?startpage=1&allowFullscreen=true" width={525} height={371} frameborder="0" allowfullscreen=""></iframe> 
                            ...
                            <p style={styles.descText}>Print Version</p>
                        </div>

                        <div className={styles.print}>
                            <iframe src="https://indd.adobe.com/embed/082cc578-f77b-40c5-bf38-014d56fe7e8e?startpage=1&allowFullscreen=true" width={525} height={371} frameborder="0" allowfullscreen=""></iframe> 
