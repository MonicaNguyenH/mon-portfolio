    ...
    const horizontalRef = useRef(null);
        ...
        useEffect(() => {
            ...
            paragraphs.forEach((target) => {
                gsap.fromTo(
                    target,
                    { opacity: 0, backgroundPositionX: "100%" }, // Start hidden with text masked
                    {
                        opacity: 1,
                        backgroundPositionX: "0%", // Reveal text by animating the background
                        duration: 1.5,
                        ease: "power3.out",
                        scrollTrigger: {
                            trigger: target,
                            ...
                            start: "top 100px", // Adjust for proper timing
                            end: "top 60%",
                            toggleActions: "play reverse play reverse", // Ensures it works on scroll up/down
                        },
                    }
                );
            });
