                ...
                if (comparisonSectionRef.current) {
                    ...
                    let tl = gsap.timeline({
                        scrollTrigger: {
                            trigger: section,
                            start: "center center",
                            end: "+=200%", // Ensures full transition
                            scrub: true,
                            pin: true,
                            anticipatePin: 1,
                            pinSpacing: true, // ✅ Prevents static locking
                        },
                        defaults: { ease: "none" },
                    });

                    // ✅ Move second image ON TOP of the first one (slide in effect)
                    tl.fromTo(
                    ...
                    // ✅ Move third image ON TOP of the second one
                    tl.fromTo(
