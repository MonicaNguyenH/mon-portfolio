    ...
    useEffect(() => {
        ...
        import("gsap/ScrollTrigger").then((scrollTriggerModule) => {
            ...
            let tl = gsap.timeline({
                scrollTrigger: {
                trigger: section,
                start: "top 85%", // ✅ Start when section is NEARLY in view
                end: "+=" + section.offsetWidth,
                scrub: true,
                pin: true,
                anticipatePin: 1,
                pinSpacing: true,
                immediateRender: false, // ✅ Prevents premature rendering issues
                once: true, // ✅ Ensures animation only runs ONCE when first scrolled into view
                invalidateOnRefresh: true,
                onEnter: () => ScrollTrigger.refresh(), // ✅ Ensures recalculation when in view
                },
                defaults: { ease: "none" },
            });
            ...
            ScrollTrigger.refresh(); // ✅ Refresh trigger calculations
            }
        });
        });
