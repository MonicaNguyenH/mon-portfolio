            ...
            import("gsap/ScrollTrigger").then(({ ScrollTrigger: ST }) => {
                ...
                if (comparisonSectionRef.current) {
                    ...
                    tl.fromTo(
                        ...
                        { clipPath: "inset(0 0 0 0%)", duration: 1, ease: "power2.out" } // ✅ Smoother transition
                    );
                    
                    // // ✅ Second image revealed over first
                    // tl.fromTo(
                    //     section.querySelector(`.${styles.thirdImage}`),
                    //     { clipPath: "inset(0 0 0 100%)" }, // Start hidden on the left
                    //     { clipPath: "inset(0 0 0 0%)", duration: 1, ease: "power2.out" }, // ✅ Smooth easing
                    //     1 // Starts after first image is revealed
                    // );
