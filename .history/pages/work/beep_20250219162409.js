            ...
            import("gsap/ScrollTrigger").then(({ ScrollTrigger: ST }) => {
                ...
                if (comparisonSectionRef.current) {
                    ...
                    tl.fromTo(
                        ...
                        { clipPath: "inset(0 0 0 100%)" }, // ✅ Image is hidden (left side covered)
                        { clipPath: "inset(0 0 0 0%)" } // ✅ Revealed from left to right
                    );
                    
                    // ✅ Second image revealed over first
                    tl.fromTo(
                        section.querySelector(`.${styles.thirdImage}`),
                        { clipPath: "inset(0 0 0 100%)" }, // ✅ Start hidden on left
