...
import { ScrollTrigger } from "gsap/dist/ScrollTrigger"; // ✅ Ensure this is imported
gsap.registerPlugin(ScrollTrigger); // ✅ Register it at the top
...
export default function Beep() {
    ...
    const horizontalRef = useRef(null);
        ...
        useEffect(() => {
            console.log("GSAP Effect Running..."); // Debugging step
            ...
            console.log("✅ Found textRef:", textRef.current);
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50 },
                {
                    ...
                    scrollTrigger: {
                        ...
                        markers: true, // REMOVE this when done debugging
                        scrub: false,
                        start: "top 90%",
                        end: "top 60%",
                        toggleActions: "play reverse play reverse",
                        onEnter: () => console.log("🔥 GSAP Animation Triggered"),
                        onLeaveBack: () => console.log("↩️ GSAP Animation Reversed"),
                    },
                }
            );
        }, []);
