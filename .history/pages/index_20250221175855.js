          ...
          <div className={`${styles.content} content`}>
            ...
            <div className={styles.featured}>
              <div className={styles.gridContainer}>
                ...
                <div className={styles.gridContainer__filterGrid}></div>
                <CardImgSquare link="/work/trea" image="/img/graphic/trea/cover.webp" title="TREA" description="Tea with a Visual Identity" />
                <CardImgSquare link="/work/artflow" image="/img/graphic/artflow/TN.webp" title="ARTFLOW" description="Where Creativity Meets Design" />
                <CardImgSquare link="/work/addicted" image="/img/graphic/addict/TN.webp" title="ADDICTED" description="Between Treatment and Dependence" />
              </div>
