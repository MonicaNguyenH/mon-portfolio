        ...
        <div className={styles.blendingMode}>
            ...
            <div className={styles.main}>
                ...
                <div className={styles.sec2}>
                    <p>Xin chào, or hello! My name is <span>Monica</span>, and I’m a digital designer and web developer based in Vancouver. I’m passionate about blending aesthetic design with seamless UX/UI to enhance user experiences—not just making things look good, but ensuring they feel good too.</p>
                </div>
            </div>
        </div>
        </>
