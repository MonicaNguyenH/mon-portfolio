          ...
          <div className={`${styles.content} content`}>
            ...
            <div className={styles.landing__sec2}>
              <p className={styles.text}>
                Digital Designer & Frontend Developer, <ToolTipButton text="bcit" tooltipText="British Columbia Institute of Technology" /> graduate.
              </p>
              <p className={styles.text}>
                Experienced in <ToolTipButton text="Digital Design" tooltipText="UI/UX, Web, Branding" />,
                <ToolTipButton text="Product Design" tooltipText="User Experience & Research" />, and
                <ToolTipButton text="Frontend Development" tooltipText="React, Next.js, JavaScript" />.
              </p>
              <p className={styles.text}>
