        ...
        <div className={styles.blendingMode}>
            ...
            <div className={styles.main}>
                ...
                <div className={styles.sec2}>
                    ...
                    <p>My portfolio reflects my love for exploring different forms of visual art. Every project feels like climbing a mountain (I’m not very athletic), but that challenge fuels my curiosity. As Albert Einstein said, <span className={styles.italicText}>“A person who never made a mistake never tried anything new.”</span></p>
